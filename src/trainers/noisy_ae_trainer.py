...
class NoisyAETrainer(BaseTrainer):
    def __init__(self, config):
        super(NoisyAETrainer, self).__init__(config)
    ...
    def inference(self, dataloader):
        ...
        for batch in dataloader:
            ...
            z = encodings + self.compute_noise(encodings.size())
            sentences = inference(self.decoder, z, self.vocab)
    ...
    def checkpoint(self):
        self.save_module_state(self.encoder, 'encoder')
        self.save_module_state(self.decoder, 'decoder')
